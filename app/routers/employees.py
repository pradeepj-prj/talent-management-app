...
async def get_employee_skills(employee_id: str, conn: DbConn):
...
async def get_skill_evidence(employee_id: str, skill_id: int, conn: DbConn):
...
async def get_evidence_inventory(employee_id: str, conn: DbConn):
